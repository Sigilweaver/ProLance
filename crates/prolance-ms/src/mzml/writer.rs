//! mzML writer.
//!
//! Thin adapter over `openproteo_core::write_mzml`. Converts ProLance's
...
//! roundtrip contract for ProLance.
//!
...
fn run_to_metadata(run: &Run) -> RunMetadata {
    ...
    RunMetadata {
        ...
        software_name: "ProLance".to_string(),
...
fn precursor_to_info(p: &prolance_core::Precursor, s: &Spectrum) -> PrecursorInfo {
    // ProLance stores symmetric lower/upper half-widths around the target.
